...
class Game:
    ...
    def __init__(self):
        ...
        self.enemy_time_alive = 0
        self.enemy_hits = 0
        self.enemy_hits_past = 0
        self.player_hits = 0
        self.player_hits_past = 0
        self.data()
    ...
    def update_time(self):
        ...
        self.player_time_alive += self.changing_time
        self.enemy_time_alive += self.changing_time
    def new(self):
        ...
        col2 = random.randint(3, 60)
        row2= random.randint(3, 39)
        col1 = random.randint(3, 60)
        row1 = random.randint(3, 39)
        for row, tiles in enumerate(self.maze):
            for col, tile in enumerate(tiles):
                ...
                if tile == '*':
                    col2 = random.randint(3, 60)
                    row2 = random.randint(3, 39)
                    print("Player position: ", col2, row2)
                    self.player=Player(self,col2 ,row2)
                if tile == '-':
                    while col2 == col1 and row2 == row1:
                        col1 = random.randint(3, 60)
                        row1 = random.randint(3, 39)
                    print("Enemy position: ", col1, row1)
                    self.enemy = Enemy(self, col1, row1)
